...
#define ALIEN_WDMG_MODIFIER         3.0f //1
#define ADM(d)                      ((int)((float)d*ALIEN_WDMG_MODIFIER))

#define ABUILDER_BUILD_REPEAT       50 //500
#define ABUILDER_CLAW_DMG           ADM(1500)
#define ABUILDER_CLAW_RANGE         64.0f
#define ABUILDER_CLAW_WIDTH         4.0f
#define ABUILDER_CLAW_REPEAT        1200 //1000
#define ABUILDER_CLAW_K_SCALE       1.0f
#define ABUILDER_BASE_DELAY         170 //*100 
#define ABUILDER_ADV_DELAY          120 //*100
#define ABUILDER_BLOB_DMG           ADM(100)
#define ABUILDER_BLOB_REPEAT        1000
#define ABUILDER_BLOB_SPEED         800.0f
#define ABUILDER_BLOB_SPEED_MOD     0.5f
#define ABUILDER_BLOB_TIME          5000

#define LEVEL0_BITE_DMG             ADM(49) //49 //69
#define LEVEL0_BITE_RANGE           64.0f
#define LEVEL0_BITE_WIDTH           6.0f
#define LEVEL0_BITE_REPEAT          500
#define LEVEL0_BITE_K_SCALE         1.0f

#define LEVEL1_CLAW_DMG             ADM(20)
...
#define LEVEL1_GRAB_RANGE           500.0f //64 //100 //800
#define LEVEL1_GRAB_TIME            300
#define LEVEL1_GRAB_U_TIME          450
#define LEVEL1_PCLOUD_DMG           ADM(4) //5 //4 march 13
#define LEVEL1_PCLOUD_RANGE         235.0f //200 //400 //250 //300 march 13
#define LEVEL1_PCLOUD_REPEAT        2000
#define LEVEL1_PCLOUD_TIME          10000

#define LEVEL2_CLAW_DMG             ADM(80) //40
...
#define LEVEL2_AREAZAP_DMG          ADM(60) //80
#define LEVEL2_AREAZAP_RANGE        340.0f //200 //400 //320
#define LEVEL2_AREAZAP_WIDTH        15.0f
#define LEVEL2_AREAZAP_REPEAT       500 //1500
#define LEVEL2_AREAZAP_TIME         1000
#define LEVEL2_AREAZAP_MAX_TARGETS  2 //3 march 13
#define LEVEL2_WALLJUMP_MAXSPEED    1000.0f

#define LEVEL3_CLAW_DMG             ADM(200)
...
#define LEVEL3_POUNCE_RANGE         72.0f //72
...
#define LEVEL3_POUNCE_CHARGE_TIME   400 // 700
#define LEVEL3_POUNCE_TIME          400
#define LEVEL3_BOUNCEBALL_DMG       ADM(8000)
#define LEVEL3_BOUNCEBALL_REPEAT    1000
#define LEVEL3_BOUNCEBALL_SPEED     1000.0f

#define LEVEL4_CLAW_DMG             ADM(150) //400 //200
...
#define LEVEL4_CHARGE_DMG           ADM(210)
...
#define ALIEN_HLTH_MODIFIER         4.0f
...
#define LEVEL3_UPG_HEALTH           AHM(180)
#define LEVEL3_UPG_REGEN            70
#define LEVEL3_UPG_COST             9

#define LEVEL4_SPEED                1.2f
#define LEVEL4_VALUE                AVM(800)
#define LEVEL4_HEALTH               AHM(375) //MBP recommendation from 400
...
#define ACIDTUBE_REPEAT             1000 //3000
...
#define TRAPPER_REPEAT              500 //1000
#define TRAPPER_K_SCALE             1.0f
#define LOCKBLOB_SPEED              2050.0f //650 f //1050
...
#define OVERMIND_REGEN              120 //6
#define OVERMIND_SPLASHDAMAGE       15000 //15
#define OVERMIND_SPLASHRADIUS       150 //300 //3000
#define OVERMIND_CREEPSIZE          120
#define OVERMIND_ATTACK_RANGE       550.0f//150
#define OVERMIND_ATTACK_REPEAT      2800 //1000
...
#define ALIEN_POISON_DMG            4 //5
#define ALIEN_POISON_DIVIDER        (1.0f/1.32f) //about 1.0/(time`th root of damage)

#define ALIEN_SPAWN_REPEAT_TIME     100 //10000
...
#define BLASTER_REPEAT              1000 //600 //800 //900
#define BLASTER_K_SCALE             1.0f
#define BLASTER_SPREAD              200
#define BLASTER_SPEED               1400 //1400
#define BLASTER_DMG                 HDM(500)

#define RIFLE_CLIPSIZE              300
#define RIFLE_MAXCLIPS              2
#define RIFLE_REPEAT                58 //90
#define RIFLE_K_SCALE               1.0f
#define RIFLE_RELOAD                1000//2000
#define RIFLE_PRICE                 0
#define RIFLE_SPREAD                200
#define RIFLE_DMG                   HDM(6)

#define PAINSAW_PRICE               1500
#define PAINSAW_REPEAT              75
#define PAINSAW_K_SCALE             1.0f
#define PAINSAW_DAMAGE              HDM(100000)//15 //75
#define PAINSAW_RANGE               45.0f //40 //60

#define GRENADE_PRICE               2600
#define GRENADE_REPEAT              0
#define GRENADE_K_SCALE             2000.0f
#define GRENADE_DAMAGE              HDM(1700)
#define GRENADE_RANGE               1200.0f
#define GRENADE_SPEED               400.0f //400
...
#define CHAINGUN_DMG                HDM(27) //6

#define PRIFLE_PRICE                400
#define PRIFLE_CLIPS                100 //50
#define PRIFLE_MAXCLIPS             4
#define PRIFLE_REPEAT               50 //100
#define PRIFLE_K_SCALE              1.0f
#define PRIFLE_RELOAD               2000
#define PRIFLE_DMG                  HDM(17)//9
...
#define FLAMER_LIFETIME             800.0f //800
...
#define HUMAN_BHLTH_MODIFIER        12.0f
...
#define MGTURRET_REPEAT             200 //100
#define MGTURRET_K_SCALE            1.0f
#define MGTURRET_RANGE              300.0f
#define MGTURRET_SPREAD             200
#define MGTURRET_DMG                HDM(8) //4
...
#define TESLAGEN_HEALTH             HBHM(300) //2 GRANGER SLASH TO GET DOWN. //700 lasttime
#define TESLAGEN_SPLASHDAMAGE       50
#define TESLAGEN_SPLASHRADIUS       100
#define TESLAGEN_REPEAT             150 //250
#define TESLAGEN_K_SCALE            4.0f
#define TESLAGEN_RANGE              250
#define TESLAGEN_DMG                HDM(15)//9
...
#define REACTOR_HEALTH              HBHM(2333) //300something
#define REACTOR_SPLASHDAMAGE        1600 //200 
#define REACTOR_SPLASHRADIUS        10000 //300 
#define REACTOR_ATTACK_RANGE        600.0f //100
#define REACTOR_ATTACK_REPEAT       300 //1000
...
#define HUMAN_SPRINT_MODIFIER       1.5f //1.2
...
#define HUMAN_SPAWN_REPEAT_TIME     100 //10000
